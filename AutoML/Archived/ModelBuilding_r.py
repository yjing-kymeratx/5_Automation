...
def Args_Prepation(parser_desc):
    ...
    parser.add_argument('--calcParamJson', action="store", default=None, help='The json file of descriptor calculater parameters')
    parser.add_argument('--normParamJson', action="store", default=None, help='The json file of descriptor normalization parameters')
    parser.add_argument('--impuParamJson', action="store", default=None, help='The json file of descriptor imputation parameters')
